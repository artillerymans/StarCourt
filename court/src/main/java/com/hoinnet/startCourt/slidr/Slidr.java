package com.hoinnet.startCourt.slidr;
...
import com.hoinnet.startCourt.R;
...
public class Slidr {
     ...
     * @return              a {@link Slidr} that allows
    ...
    /**
     * Attach a slider mechanism to an activity based on the passed {@link Slidr}
     *
     * @param activity      the activity to attach the slider to
